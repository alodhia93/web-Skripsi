                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="radio">
                                    <label>{!! Form::radio('jenisKelamin', 'LakiLaki') !!}Laki laki</label>
                                </div>
                                <div class="radio">
                        ...
                        <div class="form-group row">
                            <label for="prodi" class="col-md-4 col-form-label text-md-right">Program Studi</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fakultas" type="text" class="form-control @error('fakultas') is-invalid @enderror" name="fakultas" value="{{ old('fakultas') }}" required autocomplete="fakultas" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="foto" class="col-md-4 col-form-label text-md-right">Foto Anda</label>
                        ...
                        {!! Form::hidden('level', 'mahasiswa',['class' => 'form-control-file']) !!}
